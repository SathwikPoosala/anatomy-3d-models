...
const StudentSidebar = ({ user, onLogout, darkMode, toggleDarkMode, isOpen, toggleSidebar }) => {
    ...
    <>
      ...
      >
        ...
        <nav className="space-y-2">
          ...
          <Link to="/student/models" className={linkClass('/student/models')}>
            <span className="mr-3">🧬</span>
            3D Models
          </Link>
          ...
          <Link to="/student/marks" className={linkClass('/student/marks')}>
            <span className="mr-3">📊</span>
            Marks
          </Link>
